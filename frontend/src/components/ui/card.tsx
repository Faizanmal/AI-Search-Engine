...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "min-w-0 overflow-hidden rounded-2xl border border-border/80 bg-card/95 text-card-foreground shadow-sm backdrop-blur-[2px]",
      className
    )} 
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex min-w-0 flex-col space-y-1.5 p-5 sm:p-6", className)}
    {...props}
  />
))
